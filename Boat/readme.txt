...
##
    ...
    this can be done via the usage of the servo.SetTarget() function, this must match the preset range decided in the constructor, otherwise it will default to the closes allowed value.
